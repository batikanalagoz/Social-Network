                ...
                <div class="bio-timeline">
                    <div class="about-wrap">
                        <div class="about-header">
                            ...
                            <div class="about-text">Arkadaşlar</div>
                        ...
                        <div class="friend-follow-tab" style="margin-left:0;background-color: white;padding-left: 15px;">
                            <div class="friend-tab">
                                <div class="friend-tab"> Tüm arkadaşlar(
                                    <?php echo count($friendsdata); ?>)
                                </div>
                            </div>
                            <div class="follower-tab follow-tab"> Takipçiler(
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.post-option', function() {
                ...
                $(postDetails).show().html('<div class="post-option-details"><ul><li class="post-edit" data-postid="' + postid + '" data-userid="' + userid + '">Düzenle</li><li class="post-delete" data-postid="' + postid + '" data-userid="' + userid + '"></li><li class="post-privacy" data-postid="' + postid + '" data-userid="' + userid + '">Privacy</li></ul></div>');
            })
            ...
            $(document).on('click', '.shared-post-option', function() {
                ...
                $(postDetails).show().html('<div class="shared-post-option-details"><ul style="padding:0;"><li class="shared-post-edit" data-postid="' + postid + '" data-userid="' + userid + '">Düzenle</li><li class="shared-post-delete" data-postid="' + postid + '" data-userid="' + userid + '">Sil</li><li class="post-privacy" data-postid="' + postid + '" data-userid="' + userid + '">privacy</li></ul></div>');
            })
