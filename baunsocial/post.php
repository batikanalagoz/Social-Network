                                                            ...
                                                            <div class="nf-pro-name-time">
                                                                ...
                                                                <div class="nf-pro-time-privacy">
                                                                    ...
                                                                    <div class="nf-pro-privacy">
                                                                        <img src="../../baunsocial/assets/image/privacy.JPG" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.post-option', function() {
                ...
                $(postDetails).show().html('<div class="post-option-details"><ul><li class="post-edit" data-postid="' + postid + '" data-userid="' + userid + '">Edit</li><li class="post-delete" data-postid="' + postid + '" data-userid="' + userid + '">Sil</li><li class="post-privacy" data-postid="' + postid + '" data-userid="' + userid + '">Privacy</li></ul></div>');
            })
            ...
            $(document).on('click', '.post-delete', function() {
                ...
                var r = confirm("Gönderiyi silmek istiyor musunuz?");
