...
<body>
    ...
    <header>
        <div class="top-bar">
            ...
            <div class="top-right-part">
                ...
                <a href="index.php">
                    <span class="top-home top-css border-left">BaunSocial</span>
                </a>
                ...
                <div class="profile-cover-wrap" style="background-image: url(<?php echo $profileData->coverPic; ?>)">
                    <div class="upload-cov-opt-wrap">
                        ...
                        <div class="add-cover-photo">
                            ...
                            <div class="add-cover-text">Kapak fotoğrafı ekleyin</div>
                        </div>
                        <?php  }else{ ?>
                        ...
                        <div class="add-cov-opt">
                            <div class="select-cover-photo">Fotoğraf Seç</div>
                            <div class="file-upload">
                                <label for="cover-upload" class="file-upload-label">Fotoğraf yükle</label>
    ...
    if($userid == $profileId){ ?>
                            <div class="profile-edit-button" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                ...
                                <div class="edit-profile-button-text" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Profili Düzenle</div>
                            </div>
...
if(empty($requestConf)){  ?>
                            ...
                            <div class="profile-add-friend" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                ...
                                <div class="edit-profile-button-text">Arkadaş Ekle</div>
                            </div>
                            ...
                            <div class="profile-friend-confirm" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                <div class="edit-profile-confirm-button" style="position:relative;">
                                    <div class="con-req accept-req align-middle" data-userid="<?php $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                        <img src="assets/image/friendRequestGray.JPG" alt="">İsteği Onayla
                                    </div>
                            ...
                            <div class="profile-friend-confirm" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                <div class="edit-profile-confirm-button" style="position:relative;">
                                    <div class="con-req align-middle">
                                        <img src="assets/image/rightsignGray.JPG" alt="">Arkadaş
                                    </div>
                                    <div class="request-unfriend" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Arkadaşlıktan Çıkar</div>
                                </div>
                            </div>
                            ...
                            <div class="profile-friend-sent" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                <img src="assets/image/friendRequestGray.JPG" alt="">
                                <div class="edit-profile-button-text">Arkadaşlık isteği gönderildi</div>
                            </div>
                            <?php
        ...
        if(empty($followCheck)){ ?>
                            ...
                            <div class="profile-follow-button" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>" style="border-right:1px solid gray;">
                                ...
                                <div class="profile-activity-button-text">Takip etmek</div>
                            </div>
                            ...
                            <div class="profile-unfollow-button" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>" style="border-right:1px solid gray;">
                                ...
                                <div class="profile-activity-button-text">Takibi bırak</div>
                            </div>
                ...
                <div class="bio-timeline">
                    <div class="about-wrap">
                        <div class="about-header">
                            ...
                            <div class="about-text">Hakkımda</div>
                        ...
                        <div class="about-main">
                            <div class="about-menu">
                                <ul>
                                    <li class="overview" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span class="activeAbout" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Genel Bakış</span></li>
                                    <li class="work-education" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">İş ve Eğitim</span></li>
                                    <li class="places-lived" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Yaşadığınız Yerler</span></li>
                                    <li class="contact-basic" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">İletişim ve Temel Bilgiler</span></li>
                                    <li class="family-relation" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Aile ve İlişki</span></li>
                                    <li class="details-you" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Hakkınızdaki Detaylar</span></li>
                                    <li class="life-events" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Yaşam olayları</span></li>
                                </ul>
                            </div>
    ...
    <script>
        $(function() {
            ...
            $(document).on('change', '#profile-upload', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/baunsocial/core/ajax/profilePhoto.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            $('#adv_dem').html(/data);
                    ...
                    $.ajax({
                        url: 'http://localhost/baunsocial/core/ajax/profilePhoto.php',
                        cache: false,
                        contentType: false,
                        processData: false,
                        data: form_data,
            ...
            $('#cover-upload').on('change', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/baunsocial/core/ajax/profile.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            alert(data);
                ...
                $.ajax({
                    url: 'http://localhost/baunsocial/core/ajax/profile.php',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: form_data,
            ...
            $('.status-share-button').on('click', function() {
                ...
                if (files.length != 0) {
                    ...
                    if (error_images == '') {
                        $.ajax({
                            url: 'http://localhost/baunsocial/core/ajax/uploadPostImage.php',
                            method: "POST",
                            data: formData,
                            contentType: false,
                            cache: false,
                ...
                if (stIm == '') {
                    $.post('http://localhost/baunsocial/core/ajax/postSubmit.php', {
            ...
            $(document).on('click', '.edit-post-save', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/editPost.php', {
            ...
            function mainReactSubmit(typeR, postId, userId, nf_3) {
                ...
                $.post('http://localhost/baunsocial/core/ajax/react.php', {
                    reactType: typeR,
                    postId: postId,
                    userId: userId,
                    profileid: profileid
            ...
            $('.comment-submit').keyup(function(e) {
                if (e.keyCode == 13) {
                    ...
                    if (comment == '') {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://localhost/baunsocial/core/ajax/comment.php",
                            data: {
                                comment: comment,
                                userid: userid,
                                postid: postid,
            ...
            function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
                var profileid = "<?php echo $profileId; ?>";
                $.post('http://localhost/baunsocial/core/ajax/commentReact.php', {
                        commentid: commentID,
                        reactType: typeR,
                        postid: postid,
                        userid: userid,
            ...
            $(document).on('click', '.edit-com-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/baunsocial/core/ajax/editComment.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid
            ...
            $(document).on('click', '.com-reply-action', function() {
                $('.reply-input').empty();
                $('.reply-write').hide();
                var BASE_URL = 'http://localhost/baunsocial';
                var userid = $(this).data('userid');
                var postid = $(this).data('postid');
                var commentid = $(this).data('commentid');
                ...
                $('input.reply-input-style.reply-submit').keyup(function(e) {
                    if (e.keyCode == 13) {
                        ...
                        if (comment == '') {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "http://localhost/baunsocial/core/ajax/reply.php",
                                data: {
            ...
            function replyReactSubmit(typeR, postid, userid, commentID, commentparentid, com_nf_3) {
                var profileid = <?php echo $profileId; ?>;
                $.post('http://localhost/baunsocial/core/ajax/replyReact.php', {
                    commentid: commentID,
                    reactType: typeR,
                    postid: postid,
                    userid: userid,
            ...
            $(document).on('click', '.edit-reply-save', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/editReply.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid,
            ...
            $(document).on('click', '.post-Share', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/share.php', {
                    shareText: shareText,
                    profileid: profileid,
                    postid: postid,
                    userid: userid
            ...
            $(document).on('click', '.share-container', function() {
                ...
                window.location.href = "http://localhost/baunsocial/profile.php?username=" + userLink + "";
            })
            ...
            $(document).on('click', '.shared-edit-post-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/baunsocial/core/ajax/sharedEditPost.php', {
                    sharedPostid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal
                }, function(data) {
            ...
            $(document).on('keyup', 'input#main-search', function() {
                ...
                if (searchText == '') {
                    ...
                    $.post('http://localhost/baunsocial/core/ajax/search.php', {
            ...
            $(document).on('click', '.profile-add-friend', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/request.php', {
                    request: profileid,
                    userid: userid
                }, function(data) {
