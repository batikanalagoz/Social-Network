    ...
    <main id="main">
        ...
        <section class="cover-wrap " style="padding: 95px 0 30px 0px;">
            ...
            <div class='row follow-details d-flex justify-content-center align-items-center p-2' style="background-color:white">
                ...
                <div class="edit-profile-button" data-toggle="modal" data-target="#editProfile" style="cursor:pointer;">Profili Düzenle</div>
            </div>
...
-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="delete-post-confermation" style="border: none;text-align: center;">
                            <snap class="confirm-delete-tweet p-2"><i class="fa fa-check" style="color: #1ce449;font-size: 16px;border: 3px solid;border-radius: 50%;padding: 5px;margin-right: 10px;" aria-hidden="true"></i>Gönderi başarıyla paylaşıldı</snap>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="delete-post-confermation" style="border: none;text-align: center;">
                            <snap class="confirm-delete-tweet">Tweeti silmek istiyor musun?</snap>

                        </div>
                        <div class="modal-footer" style="border: none;justify-content: center;">
                            <button class="btn btn-danger" id="delete-post-ok" style="border-radius:25px;">Evet</button>
                            <button class="btn btn-success" id="delete-post-no" style="border-radius:25px;">Hayır</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="">
                        <h5 class="modal-title" id="exampleModalLabel">Gönderinin kötüye kullanımını bildirin</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body report-wrap">
                        ...
                        <div class="modal-footer" style="border: none;justify-content: center;">
                            <button class="btn btn-danger" id="report-post-submit" style="border-radius:25px;">Gönder</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="delete-post-confermation" style="border: none;text-align: center;">
                            <snap class="confirm-delete-comment">Yorumu silmek istiyor musunuz?</snap>

                        </div>
                        <div class="modal-footer" style="border: none;justify-content: center;">
                            <button class="btn btn-danger" id="delete-comment-ok" style="border-radius:25px;">Evet</button>
                            <button class="btn btn-success" id="delete-comment-no" style="border-radius:25px;">Hayır</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal" id="post-photo-show-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="max-width: 100vw; margin: 0px;">
                <div class="modal-content" style="border: none;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Önizleme</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
