            ...
            <div class="user-block-show-wrap" style="display: flex;justify-content: center;width: 100%;">
                <div class="user-block-show" style="margin-top:50px; border:1px solid gray; border-radius:10px;background-color:white;padding:20px; ">
                    <div class="block-icon-wrap" style="display:flex; ">
                        ...
                        <div style="font-size:18px; font-weight:600;"> Üzgünüz, bu içeriğe şu anda ulaşılamıyor </div>
                    </div>
                    <hr>
                    <div style="font-size:13px; font-weight:300;">Takip ettiğiniz bağlantının süresi dolmuş olabilir veya sayfa yalnızca sizin dahil olmadığınız bir hedef kitleye görünür olabilir.</div> <br>
                    <div style="color:blue; display:flex; font-size:14px;">
                        <a href="<?php echo $userData->userLink; ?>">Profilinize geri dönün </a> <a href="index.php" style="margin-left:10px;"> Ana sayfanıza gidin</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="profile-friend-confirm" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                <div class="edit-profile-confirm-button" style="position:relative;">
                                    <div class="con-req accept-req align-middle" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">
                                        <img src="assets/image/friendRequestGray.JPG" alt="">Isteği Onayla
                                    </div>
                                    <div class="request-cancel" data-userid="<?php  echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">İsteği iptal et</div>
                                </div>
                            </div>
        ...
        $(function() {
            ...
            $(document).on('keyup', '.emojionearea-editor', function() {
                ...
                if (regex_text != null) {
                    ...
                    $.post('http://localhost/baunsocial/core/ajax/hashtag_mention.php', {
            ...
            $(document).on('click', '.block-show', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/block.php', {
                    profileid: profileid,
                    userid: userid
                }, function(data) {
                    location.reload();
            ...
            function notificationUpdate(userid) {
                $.post('http://localhost/baunsocial/core/ajax/notify.php', {
            ...
            $('.profile-pic-upload').on('click', function() {
                $('.top-box-show').html('<div class="top-box align-vertical-middle profile-dialoge-show "> <div class="profile-pic-upload-action"> <div class="pro-pic-up "> <div class="file-upload"> <label for="profile-upload" class="file-upload-label"> <snap class="upload-plus-text align-middle"> <snap class="upload-plus-sign">+</snap>Fotoğraf Yükle</snap> </label> <input type="file" name="file-upload" id="profile-upload" class="file-upload-input"> </div> </div> <div class="pro-pic-choose"></div> </div> </div>')
            })
            ...
            $(document).on('click', '.postImage', function() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/imgFetchShow.php', {
                    fetchImgInfo: userid,
                    postid: postid,
                    imageSrc: imageSrc
                }, function(data) {
