        ...
        <div class="mes-top-bar" style="display: flex; width: 100%;height: 100vh;">
            <div class="top-left" style="flex-basis: 20%; border-bottom:1px solid lightgray;">
                <div class="top-area" style="height: 50px; width: 100%; border-bottom:1px solid lightgray;">
                    <div class="msg-setting-write" style="height: 100%;display: flex;justify-content: space-around;align-items: center;">
                        ...
                        <div class="msg-name-text" style="font-size: 22px;">Mesajlar</div>
                ...
                <div class="user-search-wrap" style="margin: 5px 0;padding: 0 10px;position:relative;">
                    <input type="text" name="" class="user-search" placeholder="Kullanıcı bul" style="width:90%;height: 25px;border-radius: 34px;border: 1px solid lightgray;padding:5px;text-align:center;">
            ...
            <div class="top-middle" style="flex-basis: 60%;border:1px solid lightgray;/* overflow: scroll; */position: relative;border-top: none;border-right: none;">
                ...
                <div class="img-text-send-show">
                    ...
                    <textarea name="" id="msgInput" cols="30" rows="10" placeholder="bir mesaj yazın..." style="height: 50px;width: 100%;    border-radius: 20px;position: absolute;bottom: 42px;"></textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            function userLoad() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/mesgFetch.php', {
                    loadUserid: userid
                }, function(data) {
            ...
            setTimeout(function() {
                $(document).on('keyup', '.emojionearea .emojionearea-editor', function(e) {
                    if (e.keyCode == 13) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://localhost/baunsocial/core/ajax/message.php",
                            data: {
            ...
            function loadMessage() {
                ...
                $.post('http://localhost/baunsocial/core/ajax/message.php', {
                    dataCount: otheridd,
                    profileid: useridd
                }, function(data) {
